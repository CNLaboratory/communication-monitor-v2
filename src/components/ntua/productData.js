        ...
        <div id="newtable" style={{margin: '50px auto', padding: '20px 30px', height: '800px'}}>
            ...
            <div className="section-display-tools">
                ...
                <div className="section-buttons">
                    ...
                    <div className='tool-card'>
                        <button className="plusButton" style={{height: '48px', width: '48px', background: 'url(images/icons8-plus-48.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}}></button>
                    </div>
                </div>
