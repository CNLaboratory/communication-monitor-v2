...
import background from "./assets/images/background-main.jpg";
import UploadFile from './components/upload-file-test';
import DataVisualization from "./components/data-visualization";
import IFrameTest from "./components/iframe-test";

import PermanentDrawerLeft from "./components/mui-sidebar";
import BootstrapNavBar from "./components/bootstrap-sidebar";
import VoltSidebar from "./components/volt-sidebar";
